...
public class EmployeeController {
    ...
    private void handleRestockProduct() {
        ...
        while (!validInput) {
            try {
                String input = ConsoleHelper.getStringInput("Enter amount to add: ");
    ...
    /**
     * Handles adding a new user to the customer list.
     */
    private void handleAddCustomer() {
        ...
        String middleName = ConsoleHelper.getStringInput("Enter Middle Name (press Enter to skip): ");
        ...
        System.out.println("Successfully added user: " + newCustomer.getName());
